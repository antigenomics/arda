...
| `integrations/nextflow/arda/` | the nf-core-style NF module (`main.nf`, `environment.yml`, `Dockerfile`), vendor-neutral. Covered by `tests/unit/test_nextflow_integration.py` |
