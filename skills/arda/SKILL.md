...
arda cluster plan --samples sheet.tsv --work-dir work/    # read-group work units, any scheduler
arda cluster submit-samples --samples sheet.tsv -d out/   # the same DAG as two SLURM arrays
```
